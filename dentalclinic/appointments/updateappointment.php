...
$read_query = "select id from doctors where username='$username'";
...
if (isset($_GET['doc_username']) && $_SESSION['user_role']=='Manager') 
        $doctor = $_GET['doc_username'];
...
if (isset($_POST['submitForm'])) {
  ...
  $schedule = $_POST['schedule'];
    ...
    if($doctor==null){
      ...
      $insert_query = "Update appointments  set doctor_id='$doctor',patient_id='$patient',schedule='$schedule'  where id='$id'";
...
<head>
  ...
  <link rel="stylesheet" href="../projectdemo/css/dashboard.css">
              ...
              <div class="card-body px-4 py-3 px-md-5">
                ...
                <form id="registrationForm" method="post">
                  <div class="form-outline mb-2">
                    ...
                    <select class="form-select" name="patient" selected="<?php echo $patient ;?>">'
                    <?php 
                ...
                echo '
                 <option value="'.$id.'"';
                 if ( $doc_username==$doctor) echo 'selected';
                 echo '>' . $name . '</option>
               ';
                        }
                      }
                  ...
                  <div class="form-outline mb-2">
                    ...
                    <input type="datetime-local" class="form-control" required name="schedule" value="<?php echo $schedule ;?>" />
                  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Schedule  busy</h5>
